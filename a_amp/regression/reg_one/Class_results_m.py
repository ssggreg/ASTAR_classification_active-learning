...
#places_vogn = ['vogn_reg.npy']

#attention VOG BIS

#places_mc = ['mc_grad_inv.npy']
#places_mc = ['mc_grad_short.npy']
#places_mc = ['mc_reg_sec_sec.npy']
#places_mc = ['mc_reg_red.npy']
#places_mc = ['mc_reg_var.npy']
#places_mc = ['mc_grad_damien.npy']
#places_mc = ['mc_reg_red_v2_44.npy']
#places_mc = ['mc_reg_var_test.npy']
places_mc = ['mc_red_test.npy']
