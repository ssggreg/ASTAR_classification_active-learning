...
class EvalNet(nn.Module):
    ...
    def __init__(self, in_size=6, hidden=64, dropout_rate=None):
...
functions = [f,max_entropy,var_ratios,mean_std,bald]

functions_str = ['f','max_entropy','var_ratios','mean_std','bald']

functions_sec = ['no_secondary','ebmal']

recalibration = ['no','yes']
