...
class SimpleConvNet(nn.Module):
    def __init__(self, in_size=13, dropout_rate=None):
...
Ytrain = np.load('Folded-Cascode-Training-Data-v2_lbl/trainy.npy')*1.
Xtest = np.load('Folded-Cascode-Training-Data-v2_lbl/testx.npy')
Ytest = np.load('Folded-Cascode-Training-Data-v2_lbl/testy.npy')*1.
...
batch_size_sample = np.ones(500).astype(int)
for i in range(100):
    batch_size_sample[i+110]=3
for i in range(300):
    batch_size_sample[i+199]=5
    
vogn_batch_size = np.ones(500).astype(int)
for i in range(100):
    vogn_batch_size[i+110]=16
for i in range(300):
    vogn_batch_size[i+199]=32
    
nb_ep = np.ones(500).astype(int)*50
for i in range(100):
    nb_ep[i+110]=10
for i in range(300):
    nb_ep[i+199]=5
