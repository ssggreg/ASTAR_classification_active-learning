...
if __name__ == '__main__': 
    ...
    for i in range(5):
        ...
        p = mp.Process(target=sampling_selection_fast_multi,args=(depart,nb_ech,nb_ep,nb_batch,batch_size_sample,vogn_batch_size,class_model,Xtrain,Ytrain,i,rez_))
        p.start()
        processes.append(p)
    ...
    w = csv.writer(open("bbbbbbb.csv", "w"))
